      ...
      <ul class="uses-list">
        <li class="uses-list-item">
          ...
          <p>
            ...
            afin d’embarquer le visiteur dans une découverte spatio-temporelle
            inédite.
          </p>
        </li>
        <li class="uses-list-item">
          ...
          <p>
            ...
            émerger auprès vos prospects (outil d’aide à la vente, salons, site
            web).
          </p>
        </li>
        <li class="uses-list-item">
          ...
          <p>
            ...
            science autrement, en 3D et en 360°, auprès de publics larges.
          </p>
        </li>
      </ul>
    </div>
    <div class="shape-1 shape-right"></div>
    <div class="shape-2 shape-right"></div>
    <div class="shape-3 shape-left"></div>
    <div class="shape-4 shape-left"></div>
    <div class="shape-5 shape-pulse"></div>
    <div class="shape-6"></div>
    <div class="shape-7 shape-pulse"></div>
    <div class="shape-8 shape-pulse"></div>
    <div class="shape-9 shape-rotate"></div>
  </section>
</template>
